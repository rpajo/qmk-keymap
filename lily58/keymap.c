...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	...
	[1] = LAYOUT(\
		KC_VOLD, 			KC_VOLU, 	KC_MUTE, 	KC_TRNS, 	KC_TRNS, 	KC_TRNS,										KC_MPLY, 	KC_MRWD, 	KC_MFFD, 	KC_TRNS,		KC_TRNS, 		KC_TRNS,
		KC_F1, 				KC_F2, 		KC_F3, 		KC_F4, 		KC_F5, 		KC_F6, 											KC_F7, 		KC_F8, 		KC_F9, 		KC_F10, 		KC_F11, 		KC_F12,
		KC_GRV, 			KC_EXLM, 	KC_AT, 		KC_HASH, 	KC_DLR, 	KC_PERC, 										KC_CIRC, 	KC_AMPR, 	KC_ASTR, 	KC_LPRN, 		KC_RPRN, 		KC_TILD,
		KC_TRNS,		 	KC_TRNS, 	KC_TRNS, 	KC_TRNS, 	KC_TRNS,	KC_TRNS, KC_TRNS, KC_TRNS, 	KC_PEQL, 	KC_UNDS, 	KC_PLUS, 	KC_LCBR, 		KC_RCBR, 		KC_PIPE, 
	...
	[2] = LAYOUT(\
		...
		KC_LCTL, 			KC_NO,		KC_NO,		KC_NO, 		KC_NO, 		KC_NO, 		KC_TRNS, KC_TRNS,	KC_PLUS,	KC_MINS, 	KC_EQL, 	KC_LBRC, 		KC_RBRC, 		KC_BSLS,
